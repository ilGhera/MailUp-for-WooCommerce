...
* Add a newsletter subscription flag in your site registration form
...
== Screenshots ==
1. Options related to the newsletter flag in the WordPress registration form
2. Subscription button general options
3. Subscription button specific options
4. Single WooCommerce product settings
